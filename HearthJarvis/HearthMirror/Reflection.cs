...
namespace HearthMirror
{
	public class Reflection
	{
        ...
        public static List<Card> GetFriendHandCards() =>  GetHandCardsInternal(Side.FRIENDLY, "ZoneHand");

        private static List<Card> GetHandCardsInternal(Side side, string zoneName)
        {
